...
if (!message.member.hasPermission("KICK_MEMBERS")) return message.reply("<a:nao:809880719814819880> | Você é fraco, e não pode usar esse comando!");
        ...
        if (mentionedMember.roles.highest.position >= message.member.roles.highest.position && message.author.id !== message.guild.owner.id) {
            return message.reply("<a:error3:818556346852573235> **|** Eu não posso expulsar este user, porque eu não tenho permissão ou o cargo e maior do que o seu!")
        }
